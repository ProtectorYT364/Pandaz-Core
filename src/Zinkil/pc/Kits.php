...
class Kits{
	...
	public static function sendKit(Player $player, $kit){
		switch($kit){
			...
			$ffa=ItemFactory::getInstance()->get(ItemIds::DIAMOND_SWORD, 0, 0);
